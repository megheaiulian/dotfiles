...
if ($TERM =~# '256' || &t_Co >= 256) || has('gui_running')
  ...
  hi LineNr           ctermbg=236  ctermfg=240  guibg=#262626 guifg=#444444 cterm=NONE           gui=NONE
  ...
  hi MatchParen       ctermbg=235  ctermfg=red  guibg=NONE    guifg=#ff8700 cterm=underline      gui=underline
  hi SignColumn       ctermbg=236  ctermfg=242  guibg=#1c1c1c guifg=#6c6c6c cterm=NONE           gui=NONE
...
elseif &t_Co == 8 || $TERM !~# '^linux' || &t_Co == 16
  ...
  hi Normal           ctermbg=            ctermfg=white          cterm=NONE
  ...
  hi MatchParen       ctermbg=black       ctermfg=red      cterm=underline
  ...
  hi SignColumn       ctermbg=236       ctermfg=darkgray    cterm=NONE
